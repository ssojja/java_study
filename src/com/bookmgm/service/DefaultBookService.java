...
public class DefaultBookService implements BookService{
	...
	public Book createBook() {
		...
		book.setIsbn(rd.nextInt(1000, 9999));	// 도서 번호 생성
	...
	public void register() {
		...
		if(repository.insert(book) == 1) System.out.println("✅도서가 등록되었습니다."); // 등록 성공
		else System.out.println("🚫도서가 등록되지 않았습니다."); // 등록 실패
		bma.showMenu();
	};
	...
	public void delete() {
		if(getCount() != 0) {
			...
			Book book = repository.find(scan.next());
